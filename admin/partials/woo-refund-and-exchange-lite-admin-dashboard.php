...
<header>
	...
	<div class="wps-header-container wps-bg-white wps-r-8">
		...
		if ( ! is_plugin_active( 'woocommerce-rma-for-return-refund-and-exchange/mwb-woocommerce-rma.php' ) ) {
			?>
			<a class="wps_go_pro_link" style="background: #05d5d8;color: white;font-weight: 700;padding: 2px 5px;border: 1px solid #139d09;border-radius: 5px;" target="_blank" href="https://wpswings.com/product/rma-return-refund-exchange-for-woocommerce-pro?utm_source=wpswings-rma-pro&utm_medium=rma-org-backend&utm_campaign=go-pro"><?php esc_html_e( 'GO PRO', 'woo-refund-and-exchange-lite' ) ?></a>
		<?php } ?>
