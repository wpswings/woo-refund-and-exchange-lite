						...
						?>
							...
							<?php if ( isset( $om_val['files'] ) && ! empty( $om_val['files'] ) ) { ?>
								...
								<div class="mwb_order_msg_attach_container">
									<div class="mwb_order_msg_attachments_title"><?php esc_html_e( 'Attachment:', 'woo-refund-and-exchange-lite' ); ?></div>
									<?php
		...
		<form id="mwb_order_new_msg_form" method="post" enctype="multipart/form-data" action="">
			...
			<div class="mwb-order-msg-attachment-wrapper mwb_rma_flex">
				...
				<div class="mwb-order-msg-btn">
					<input type="submit" class="button button-primary" id="mwb_order_msg_submit" value="<?php esc_html_e( 'Send', 'woo-refund-and-exchange-lite' ); ?>" name="mwb_order_msg_submit" data-id="<?php echo esc_attr( $order_id ); ?>">
				</div>
			</div>	
		</form>
	</div>
