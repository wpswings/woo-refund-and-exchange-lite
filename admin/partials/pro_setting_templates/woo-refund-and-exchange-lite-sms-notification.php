...
$mwr_sms_notification_settings =
// Wallet Setting register filter.
apply_filters( 'wps_rma_sms_notification_settings_array', array() );
?>
<!--  template file for admin settings. -->
<form action="" method="POST" class="wps-mwr-gen-section-form">
	<div class="mwr-secion-wrap">
		<?php
		$mwr_sms_notification_html = $wrael_wps_rma_obj->wps_rma_plug_generate_html( $mwr_sms_notification_settings );
		echo esc_html( $mwr_sms_notification_html );
