...
echo sprintf( esc_html__( 'To Configure Cancel Related Email %s.', 'woo-refund-and-exchange-lite' ), '<a class="' . esc_html( $rma_pro_activate ) . '" href="' . esc_html( $woo_email_url ) . '">Click Here</a>' );
?>
</h6>
