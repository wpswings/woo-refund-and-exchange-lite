		...
		<div class='wps_wrma_accordion'>
			<div class="wps_wrma_accord_sec_wrap">
				<h4 id="wrma_shiprocket_heading" class="wps_wrma_basic_setting wps_wrma_slide_active">
					<?php esc_html_e( 'ShipRocket Configuration', 'woocommerce-rma-for-return-refund-and-exchange' ); ?>
				</h4>
				<div class='wps_wrma_validate_form_wrapper'>
					<!-- loader -->
					<div class="wps_wrma_return_loader">
					...
					<div class="wps_wrma_ship_station <?php echo esc_html( $wps_wrma_hide_form ); ?> ">
						...
						<h6>
							...
							/* translators: %s: search term */
							echo sprintf( esc_html__( 'To Get Api Details For Shiprocket %s.', 'woocommerce-rma-for-return-refund-and-exchange' ), '<a href="' . esc_html( $woo_shiprocket_url ) . '" target="_blank">Click Here</a> Shiprocket Dashboard' );
							?>
						</h6>
						<br>
						<p class='submit'>
							<a href='javascript:void(0)' class='wps_wrma_validate_shiprocket_key wps-rma-admin__button' ><?php esc_html_e( 'Validate Account', 'woocommerce-rma-for-return-refund-and-exchange' ); ?>
							</a>
						</p>
						<div class="wps-wrma-validation__wrap">
						...
						<h6>
							...
							/* translators: %s: search term */
							echo sprintf( esc_html__( 'To Get Channel Details Form Shiprocket %s.', 'woocommerce-rma-for-return-refund-and-exchange' ), '<a href="' . esc_html( $woo_shiprocket_channel_url ) . '" target="_blank">Click Here</a> Shiprocket Dashboard' );
							?>
						</h6>
					</div>
					<!-- Validation form ends -->
			...
			<div class="wps_wrma_accord_sec_wrap">
				<h4 id="wps_wrma_shiprocket_details_heading" class="wps_wrma_basic_setting wps_wrma_slide_active">
					<?php esc_html_e( 'Ship Rocket Warehouse Address', 'woocommerce-rma-for-return-refund-and-exchange' ); ?>
				</h4>
				<div class="wps_wrma_shipstation_details_wrapper">
					<table>
						<tbody>
							<tr valign="top">
								<th class="titledesc" scope="row">
									<label for="wps_wrma_shiprocket_admin_firstname"><?php esc_html_e( 'Admin First Name', 'woocommerce-rma-for-return-refund-and-exchange' ); ?></label>
								</th>
								<td class="forminp forminp-text">
									<?php
							...
							<tr valign="top">
								<th class="titledesc" scope="row">
									<label for="wps_wrma_shiprocket_admin_lastname"><?php esc_html_e( 'Admin Last Name', 'woocommerce-rma-for-return-refund-and-exchange' ); ?></label>
								</th>
								<td class="forminp forminp-text">
									<?php
							...
							<tr valign="top">
								<th class="titledesc" scope="row">
									<label for="wps_wrma_shiprocket_addr1"><?php esc_html_e( 'Address 1', 'woocommerce-rma-for-return-refund-and-exchange' ); ?></label>
								</th>
								<td class="forminp forminp-text">
									<?php
							...
							<tr valign="top">
								<th class="titledesc" scope="row">
									<label for="wps_wrma_shiprocket_addr2"><?php esc_html_e( 'Address 2', 'woocommerce-rma-for-return-refund-and-exchange' ); ?></label>
								</th>
								<td class="forminp forminp-text">
									<?php
							...
							<tr valign="top">
								<th class="titledesc" scope="row">
									<label for="wps_wrma_shiprocket_city"><?php esc_html_e( 'City', 'woocommerce-rma-for-return-refund-and-exchange' ); ?></label>
								</th>
								<td class="forminp forminp-text">
									<?php
							...
							<tr valign="top">
								<th class="titledesc" scope="row">
									<label for="wps_wrma_shiprocket_postcode"><?php esc_html_e( 'Postcode', 'woocommerce-rma-for-return-refund-and-exchange' ); ?></label>
								</th>
								<td class="forminp forminp-text">
									<?php
							...
							<tr valign="top">
								<th class="titledesc" scope="row">
									<label for="wps_wrma_shiprocket_country"><?php esc_html_e( 'Country', 'woocommerce-rma-for-return-refund-and-exchange' ); ?></label>
								</th>
								<td class="forminp forminp-text">
									<?php
							...
							<tr valign="top">
								<th class="titledesc" scope="row">
									<label for="wps_wrma_shiprocket_state"><?php esc_html_e( 'State', 'woocommerce-rma-for-return-refund-and-exchange' ); ?></label>
								</th>
								<td class="forminp forminp-text">
									<?php
							...
							<tr valign="top">
								<th class="titledesc" scope="row">
									<label for="wps_wrma_shiprocket_phone"><?php esc_html_e( 'Phone', 'woocommerce-rma-for-return-refund-and-exchange' ); ?></label>
								</th>
								<td class="forminp forminp-text">
									<?php
							...
							<tr valign="top">
								<th class="titledesc" scope="row">
									<label for="wps_wrma_shiprocket_email"><?php esc_html_e( 'E-Mail', 'woocommerce-rma-for-return-refund-and-exchange' ); ?></label>
								</th>
								<td class="forminp forminp-text">
									<?php
