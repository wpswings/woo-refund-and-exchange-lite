=== Return Refund and Exchange For WooCommerce - Create A Simple Refund System WooCommerce RMA with Exchange, Wallet & Cancel Order Features ===
...
* Admin can add the Shortcode for order_id in the emails to track down the customer from whom WooCommerce refund and RMA exchange request is made.
...
With our Return Refund and Exchange plugin, merchants can create a dedicated refund system, which offers money back guarantee, and where they can build an email template to send to the customers who ask for a refund. Merchants can add the name, email, email header, and footer for their email template
...
Visit [**Return Refund and Exchange For WooCommerce Documentation**](https://docs.wpswings.com/woocommerce-refund-and-exchange-lite/?utm_source=wpswings-rma-doc&utm_medium=rma-org-page&utm_campaign=rma-doc) and learn more about the features and working of the WooCommerce Returns Plugin.
...
* The RMA exchange Plugin is compatible with the WordPress Multilingual (WPML) plugin for the localization of the plugin’s strings.
...
This is an outstanding setup tab available on the WooCommerce RMA plugin,  in order to set up the predefined set of rules for the refund request based.

**2. Advanced Wallet System**
WooCommerce Return plugin provides flexibility to your customers to get the refunded amount in the customer’s e-wallet of your store.

**3. Partial Refund and Exchange or Cancel**
Creating partial WooCommerce refund and exchange or cancellation are not a hassle any more. The users can utilize our Partial Refund/Exchange/Cancel order feature of the plugin.
...
**7. Increase Communication Chances Using Messages**
WooCommerce Return Plugin allows your customers to send their product-related queries along with multimedia files and approach you to take relevant action for the same.
...
== TAKE ADVANTAGE OF THE EXCLUSIVE FEATURES OF WOOCOMMERCE EXCHANGE PREMIUM PLUGIN == 
...
* New: Compatibility with the Latest WC (6.2.2) and WP (7.7.0)
* New: Added the Pro Feature Tag
* Fix: fixes issue related to attachment on refund form
