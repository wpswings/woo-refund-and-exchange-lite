			...
			<table class="wps-rma-product__table">
				...
				<tbody>
					...
					<tr>
						...
						<input type="hidden" name="wps_rma_total_refund_price" class="wps_rma_total_refund_price" value="<?php echo esc_html( $wps_total_actual_price ); ?>" data-shipping_price= "<?php echo $shipping_price;?>">
							<?php
							if ( 'wps_rma_inlcude_tax' === $wps_rma_check_tax ) {
								if( empty( $pro_active) && 'on' == $wps_rma_allow_refund_shipping_charge ){
									?>
