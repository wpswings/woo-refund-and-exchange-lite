 ...
 * @extends \WC_Email
 */
class Mwb_Rma_Refund_Request_Cancel_Email extends WC_Email {
	/**
	 * Set email defaults
	 *
	 * @since 0.1
	...
	public function __construct() {
		...
		$this->id = 'mwb_rma_refund_request_cancel_email';

		// this is the title in WooCommerce Email settings.
		$this->title = 'RMA Refund Request Cancel Email';
		// this is the description in WooCommerce email settings.
		$this->description = 'Admin to Customer Refund Request Cancel Emails<h1>These are shorcodes available for the custom email</h1><br><span>{site_title}, {site_address}, {site_url}, {message_date}, {order_id}</span></b>';
		...
		$this->template_html  = 'mwb-rma-refund-request-cancel-email-template.php';
		$this->template_plain = 'mwb-rma-refund-request-cancel-email-template.php';
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'additional_content' => array(
				'title'       => __( 'Custom Email', 'woocommerce' ),
				'description' => __( 'If N/A then default email will send.', 'woo-refund-and-exchange-lite' ) . ' ' . $placeholder_text,
				'css'         => 'width:400px; height: 75px;',
				'placeholder' => __( 'N/A', 'woo-refund-and-exchange-lite' ),
				'type'        => 'textarea',
