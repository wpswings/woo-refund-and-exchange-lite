 ...
 * @extends \WC_Email
 */
class Mwb_Rma_Refund_Request_Email extends WC_Email {
	/**
	 * Set email defaults
	 *
	 * @since 0.1
	...
	public function __construct() {
		...
		$this->id = 'mwb_rma_refund_request_email';

		// this is the title in WooCommerce Email settings.
		$this->title = 'RMA Refund Request Email';
		// this is the description in WooCommerce email settings.
		$this->description = 'Customer to Admin Side Refund Request Emails<h1>These are shorcodes available for the custom email</h1><br><span>{site_title}, {site_address}, {site_url}, {message_date}, {order_id}</span></b>';
		...
		$this->template_html  = 'mwb-rma-refund-request-email-template.php';
		$this->template_plain = 'mwb-rma-refund-request-email-template.php';
